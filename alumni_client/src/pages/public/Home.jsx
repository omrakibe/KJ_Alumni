...
function Home() {
  ...
  return <div className="home">
    <nav className="public-nav"><div className="container public-nav-inner"><Link to="/" className="public-brand"><span className="public-brand-mark">KJ</span><span>KJCOEMR <small>Alumni Network</small></span></Link><div className="public-nav-links"><a href="#community">Community</a><a href="#events">Events</a><a href="#why-join">Why join</a><Link to="/login">Sign in</Link><Link to="/register" className="public-nav-cta">Join the network <ArrowRight size={16} /></Link></div></div></nav>
