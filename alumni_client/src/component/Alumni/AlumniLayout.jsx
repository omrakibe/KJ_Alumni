...
import { CalendarDays, ExternalLink, GraduationCap, LogOut, Menu, PanelLeftClose, UserRound } from "lucide-react";
...
export default function AlumniLayout({ children }) {
  ...
  const [collapsed, setCollapsed] = useState(() => localStorage.getItem("alumniSidebarCollapsed") === "true");
